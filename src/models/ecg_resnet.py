...
def ecg_resnet18(**kwargs: Any) -> ResNet:
    return _resnet("ecg_resnet18", BasicBlock, [2, 2, 2, 2], [3, 3, 3, 3], **kwargs)


def ecg_resnet34(**kwargs: Any) -> ResNet:
    return _resnet("ecg_resnet34", BasicBlock, [3, 4, 6, 3], [3, 3, 3, 3], **kwargs)


def ecg_resnet50(**kwargs: Any) -> ResNet:
    return _resnet("ecg_resnet50", Bottleneck, [3, 4, 6, 3], [3, 3, 3, 3], **kwargs)


def ecg_resnet34_psvt(**kwargs: Any) -> ResNet:
    return _resnet(
        "ecg_resnet34_psvt", BasicBlock, [3, 4, 6, 3], [15, 13, 11, 9], **kwargs
    )
